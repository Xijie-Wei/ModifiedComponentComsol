...
class ComponentComsol : public ComponentFieldMap {
 public:
  ...
  // Modifield file
  bool InitialiseMagnticField(const std::string &header = "mesh.mphtxt",
                  const std::string &mplist = "dielectrics.dat",
                  const std::string &field = "magneticfield.txt",
                  std::string unit = "");
 ...
 private:
  ...
  bool m_EnableMagneticField{false};
